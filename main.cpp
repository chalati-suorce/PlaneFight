...
// --- ���������ƾ������� ---
void outTextCenter(int x, int y, const char* str, int fontSize = 20, const char* fontName = "΢���ź�") {
    LOGFONT f;
    gettextstyle(&f);
    f.lfHeight = fontSize;
...
private:
    ...
    void runMenu() {
        ...
        outTextCenter(WIN_WIDTH / 2 + 2, 122, "���������ķɻ���ս", 32, "΢���ź�");
        outTextCenter(WIN_WIDTH / 2 + 2, 162, "��ͼ��", 32, "΢���ź�");

        settextcolor(COLOR_TEXT);
        outTextCenter(WIN_WIDTH / 2, 120, "���������ķɻ���ս", 32, "΢���ź�");
        outTextCenter(WIN_WIDTH / 2, 160, "��ͼ��", 32, "΢���ź�");
